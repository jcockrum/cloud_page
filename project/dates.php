<?php session_start(); $_SESSION['pid'] = 'date'; ?>  
<?php define("title","Date Manager"); ?>
...
<?php define("pageid","dates"); ?>
<?php include('includes/_header.php'); ?> 

<?php include('includes/_dates_content.php'); ?>
<?php include('includes/_dates_form.php'); ?>
